...
Aisha works in customer operations for a company preparing to move account data to a new platform. During a project workshop, she notices that the migration plan assumes every customer record has one active owner. Her team knows this is untrue: bereavement cases, disputed accounts, and fraud investigations follow different rules.
...
## Participation requires more than an opportunity to speak

Participation has at least four stages:

1. **Access:** Can the person use the relevant channel?
2. **Expression:** Can they state the information with reasonable support and time?
3. **Consideration:** Does an authorised person assess it against a known standard?
4. **Closure:** Do they learn what happened and why, within lawful and practical limits?
...
## 1. An affected role is absent

Exclusion can be obvious: a schedule redesign proceeds without anyone from the night shift. It can also occur despite nominal representation. One manager attends for four distinct job groups. A policy function sends a senior specialist who has never used the process under review. A customer panel includes users of the main service but none who rely on an exception route.

Affected people do not automatically have a veto, and lived experience does not answer every technical question. It can reveal operating conditions that planners miss. Aisha knows that some records cannot follow the ordinary ownership model. Her evidence matters even if technology leaders retain launch authority.
...
Representatives should know whose views they represent, how to gather them, what they may disclose, and how to report back. Otherwise, leaders may say “operations was consulted” simply because someone attended without a mandate or enough information.

Urgency may require a smaller group. Record why, keep the temporary decision as reversible as possible, and review it promptly with affected roles. Emergency arrangements should not become permanent by default.
...
- Which business need and criteria support it?
- Was it already planned?
- How were comparable employees treated?
- Does it prevent participation in the review or create unusual hardship?
- Were alternatives considered?
- What did the decision-maker know about the concern?

During a sensitive process, managers should preserve the reasons for significant employment decisions affecting a reporter, witness, respondent, or close collaborator. The record protects all sides. It may confirm a legitimate reason, reveal an avoidable conflict, or identify a decision that needs independent review.
...
A warning may be indirect: “Think about your career.” “We need team players.” “You can keep pushing, but I would choose your battles.” “People remember who supported the transformation.” These statements may be sincere advice about timing, tone, or repeated debate. They can also imply that advancement, belonging, or security depends on agreement.

Context matters. A manager may appropriately explain that a decision is final and continued refusal to implement it will affect performance. A fair explanation distinguishes the right to raise a concern from the obligation to carry out lawful, safe, agreed work:

> Your objection is recorded, and the risk owner has decided to proceed. Unless new evidence emerges or you believe a protected safety or legal route applies, your role is now to implement the decision. I will evaluate the quality of that work, not the fact that you disagreed.

An unfair explanation makes the standard vague and personal: show enthusiastic support for leaders or risk being considered disloyal.

Psychological safety is a team’s shared belief that taking interpersonal risks, such as asking questions, admitting errors, or raising concerns, is safe. It does not mean comfort, consensus, immunity from standards, or permission to mistreat others. Research has linked psychological safety to learning behaviour. Later meta-analytic work has examined a wider range of factors associated with it and its outcomes.[^3]

Managers shape this climate through everyday responses. Do they thank people for inconvenient information? Ask a genuine question? Ridicule the wording? Require every concern to come with a solution? Publicly speculate about the speaker’s motives? Follow up later? Employees learn from how other speakers are treated as well as what leaders say about openness. Research on leadership and employee voice similarly examines whether leaders’ behaviour supports an apparently open door.[^4]

If a comment sounds like a warning, ask what behaviour is expected: “Are you saying that raising this issue will affect my evaluation, or that you need a different action from me now?” Direct clarification may be unsafe where the other person has substantial power. In that case, record the words, setting, witnesses, and subsequent decisions, then use an appropriate confidential or protected route.
...
A small organisation may not have an uninvolved executive for every dispute. It can disclose that limitation, use an external adviser for a matter with significant consequences, separate fact gathering from the final decision, or add a second reviewer. Naming a different reviewer is useful only if it creates a real opportunity to detect and correct error.

Track outcomes. A process in which no appeal succeeds may be accurate, but warrants examination. So does one in which almost every case comes back because the original decision lacked reasons. Use these patterns to improve the first-stage process, without penalising people for appealing.

## Challenge can be constructive, repetitive, or harmful

Speaking up is not always constructive. Challenges may be poorly informed, abusive, discriminatory, obstructive, or repeated after fair closure without new evidence. Colleagues have a legitimate interest in being able to work.

Assess content and conduct separately. An important safety warning may be delivered rudely; address both the risk and the manner. A courteous question may conceal harassment or repeated attempts to reopen a settled issue. Do not dismiss evidence because the speaker is difficult or excuse mistreatment because the speaker is right.
...
Anonymous reporting has benefits and limits. It may make reporting possible where fear is high, but can restrict follow-up, evidence testing, and response. Offer it where appropriate and explain the limits. Protect identity as far as law and process permit, and prohibit attempts to identify a reporter outside authorised handling. Do not promise complete anonymity when the facts or legal duties may make it impossible.

## Participation must work across time, distance, and difference

Logistics can prevent participation without anyone expressing hostility. Consultation takes place only by video during headquarters hours. A paper assumes fluent professional English. A fast verbal exchange favours people who already know the history. A warehouse employee has no private device for the reporting portal. A colleague using assistive technology receives an inaccessible scanned document.
...
Input submitted outside meetings needs a deadline and an owner. “Add comments when you can” may result in comments arriving after the proposal is effectively settled. State when input can still change the direction, which question it should address, and who will bring it together. Preserve evidence that differs from the majority view, including unusual findings, rather than treating every comment as a vote.

Facilitators can improve live participation while allowing people to contribute in different ways. Send questions in advance. Begin with silent reading or written reflection. Invite contributions by relevant role instead of repeatedly relying on confident volunteers. Pause before moving on and let participants correct the summary. For decisions involving powerful participants, consider collecting initial assessments before senior leaders state a preference.

People should be able to request accessibility adjustments without publicly disclosing a diagnosis. Provide a clear request route and involve qualified support under applicable law and policy. Readable documents, captions, keyboard access, adequate notice, plain language, and multiple ways to respond can help many people without individual negotiation.

Check for participation overload. Employee-resource-group leaders, frontline representatives, and minority colleagues may repeatedly be asked to educate project teams on top of their usual work. Track this demand, pay or recognise substantial contributions, rotate participation where appropriate, and make the relevant expertise part of ordinary roles. Relying on unrecognised extra work can reproduce the burden that inclusion is meant to reduce.

Distinguish the number reached from how well participants represent the affected population. An open survey with many responses may still exclude people who lack time, trust, language access, or connectivity. A small structured sample may reveal more. State who participated and who may be missing. Do not say “everyone had a chance” if participation depended on conditions many people lacked.
...
Second, acknowledge the concern without reaching a conclusion: “Thank you for telling me. I have not assessed what happened yet, but I understand the concern is that the migration rule could mishandle bereavement accounts.” Acknowledgement does not mean agreement, and remaining neutral does not require indifference.
...
Choose a current decision and follow the route available to someone with relevant but inconvenient information.

Can they find the channel without the decision-maker’s permission? Can they use it during paid time or with reasonable accommodation? Do they understand the difference between consultation and authority? Will someone acknowledge and route their input? Can the reviewer request more information? Will the person receive closure? Is there a route for urgent, confidential, or protected matters?

Examine what happens after a concern is raised. Where lawful and proportionate, compare access, workload, evaluations, opportunities, and treatment before and after it. Use limited data, authorised reviewers, defined retention periods, and privacy safeguards. Do not create a permanent surveillance category for reporters.

Report in aggregate what leaders heard and what changed. Do not use selected comments to claim that “employees asked for” a predetermined plan. Describe the response accurately—implemented, tested, deferred, declined, referred, or under review—and explain why.

## Returning to Aisha

The programme director reopens Aisha’s issue after the operations head asks for evidence supporting its closure. No existing procedure covers the migration exceptions. The team delays only the affected record categories, tests a manual route, and assigns a product owner to build the permanent control.

The early review meeting remains because of regional attendance. Aisha can submit evidence outside the meeting and joins a rotating session during her normal hours. The six-page form is replaced by a short initial submission, followed by questions where needed. Her manager acknowledges that the remark about who was “helping” could reasonably sound like a warning and clarifies that disagreement will not affect evaluation. The reconciliation work is redistributed because it prevented the person with relevant knowledge from participating.

These changes do not guarantee that Aisha’s next concern will be accepted. They allow it to reach an accountable decision-maker without unnecessary personal cost.
...
That path is especially vulnerable when authority, access, or operating knowledge is concentrated in one person or role. The next chapter examines how this concentration becomes entrenchment and how to preserve continuity while keeping control open to review.
...
[^3]: Amy C. Edmondson, “Psychological Safety and Learning Behavior in Work Teams,” *Administrative Science Quarterly* 44, no. 2 (1999): 350–383, [https://doi.org/10.2307/2666999](https://doi.org/10.2307/2666999); M. Lance Frazier et al., “Psychological Safety: A Meta-Analytic Review and Extension,” *Personnel Psychology* 70, no. 1 (2017): 113–165, [https://doi.org/10.1111/peps.12183](https://doi.org/10.1111/peps.12183).

[^4]: James R. Detert and Ethan R. Burris, “Leadership Behavior and Employee Voice: Is the Door Really Open?” *Academy of Management Journal* 50, no. 4 (2007): 869–884, [https://doi.org/10.5465/amj.2007.26279183](https://doi.org/10.5465/amj.2007.26279183).

[^5]: International Labour Organization, *Violence and Harassment Convention, 2019 (No. 190)*, [https://normlex.ilo.org/dyn/nrmlx_en/f?p=NORMLEXPUB:12100:0::NO::P12100_INSTRUMENT_ID:3999810](https://normlex.ilo.org/dyn/nrmlx_en/f?p=NORMLEXPUB:12100:0::NO::P12100_INSTRUMENT_ID:3999810). Applicability depends on national ratification and law.
