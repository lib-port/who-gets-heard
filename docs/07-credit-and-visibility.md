...
1. **At start:** name the accountable owner, working lead, and major contribution areas.
2. **Before circulation:** let material contributors review the contribution line and substantive representation of their work.
3. **Before presentation:** explain the audience rule, choose presenter and respondent roles, and decide who attends.
4. **At close:** record contribution and lessons in the project system and relevant performance processes.
5. **When reused:** preserve source attribution and update roles if the story changes.
...
1. the oversimplified version people commonly repeat;
2. an exhaustive version listing every task and contributor; and
3. a useful version naming origins, material contributions, and accountability at the level the audience needs.
